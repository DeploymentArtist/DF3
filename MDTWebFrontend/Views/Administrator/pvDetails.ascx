<%@ Control Language="VB" Inherits="System.Web.Mvc.ViewUserControl(Of MaikKoster.MDT.MVC.AdministratorAssignmentsView)" %>
<%="" %>
<br />
<h2>
    Current assignments for Administrator <%=Html.Encode(Model.Administrator)%>
</h2>
    <div class="clear">
