<%@ Control Language="VB" Inherits="System.Web.Mvc.ViewUserControl(Of MaikKoster.MDT.MVC.ApplicationAssignmentsView)" %>
<%="" %>
<br />
<h2>
    Current assignments for Application <%=Html.Encode(Model.Application.Name)%>
</h2>
    <div class="clear">
