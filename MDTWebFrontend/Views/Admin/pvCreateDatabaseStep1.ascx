<%@ Control Language="VB" Inherits="System.Web.Mvc.ViewUserControl(Of MaikKoster.MDT.MVC.ConfigurationView)" %>
    ...
    <% Using Html.BeginForm("CreateDatabaseStep1", "Admin", Nothing, FormMethod.Post, New With {.Class = "MDTForm"})%>
        ...
        <div>
            <div id="commonconf" style="width:200px;" class="ui-widget-content ui-corner-all mdt-widget configuration">
                ...
                <div class="Settings">  
                    ...
                    <input type="submit" value="Next" name="SaveChanges" class="ui-state-default fg-button ui-corner-all"/>
                </div>
                <br />--%>
                <div class="ui-widget-header mdt-widget-header">
                    Status Information
            ...
            <div id="mdtdbconfiguration" style="width:325px;" class="ui-widget-content ui-corner-all mdt-widget configuration">
                ...
                <div class="Settings">
                    <table width="100%">
                        ...
                        <tr>
                            <td colspan="2">
                                <input type="radio" name="chkNewOrExisting" value="New" title="Create new Database" checked="checked" /> Create new Database
                            </td>

                        </tr>
                        <tr>
                            <td colspan="2">
                                <input type="radio" name="chkNewOrExisting" value="Existing" title="Use existing Database" /> Use existing Database
                            </td>
                        </tr>
                    </table>
                    <input type="submit" value="Cancel" name="SaveChanges" class="ui-state-default fg-button ui-corner-all"/>
